<form id="" class="form" method="POST" action="{{ route('tasks.store') }}" enctype="multipart/form-data">
    ...
    <div class="fv-row mb-5">
        ...
        <textarea name="notes" class="form-control form-control-solid rounded-3" required></textarea>
    </div>
    <div class="fv-row mb-5">
        <label class="required fs-6 fw-bold form-label mb-2">Additional Details</label>
        <textarea name="additional_details" class="form-control form-control-solid rounded-3" required></textarea>
    </div>
    <div class="fv-row mb-5">
