<form id="tasks_update_form" class="form" method="POST" action="{{ route('tasks.update',$task->id) }}" enctype="multipart/form-data">
    @method("PUT")
    @csrf
    <!--begin::Input group-->
    <div class="row">
        ...
        <div class="col-lg-6">
            <div class="fv-row mb-5">
                ...
                <textarea name="additional_details" class="form-control form-control-solid rounded-3" rows="14">{{$task->additional_details}}</textarea>
            </div>
        </div>
        <div class="col-lg-12">
            <div class="fv-row mb-5">
                <label class="fs-3 fw-bolder form-label mb-2">Files ({{count($taskFile)}})</label>
                <div class="card-body p-0">
                    <!--begin::Files-->
                    <div class="row">
                        @for ($i = 0; $i < count($taskFile); $i++)
                        <div class="col-lg-4">
                            <div class="d-flex align-items-center mb-5 me-10">
